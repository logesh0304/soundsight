...
def camstart():
    btn_capture['state']=NORMAL
    btn_upload['state']=DISABLED
    btn_startcam['state']=DISABLED
    btn_gentext['state']=DISABLED
    global runcam
    runcam=True
    threading.Thread(target=camrun).start()

def capture():
    btn_capture['state']=DISABLED
    btn_upload['state']=NORMAL
    btn_startcam['state']=NORMAL
    btn_gentext['state']=NORMAL
